...
Sera_q_passou = list(filter(lambda x: sum(x['Notas']) /len(x['Notas']) > 8.5, Estudantes))
print(Sera_q_passou)
...
# Enumerate
Livros = ["Cosmos", "Estoicismo", "Mindset", "AC1", "AC Renascença", "AC Brotherhood", "AC Revelations"]
